# UmaMusumeDBBrowser
## Описание
UmaMusumeDBBrowser предназначена для просмотра базы данных игры Uma Musume Pretty Derby, а также считывания событий, умений, подсказок, генов и заданий с окна игры.
